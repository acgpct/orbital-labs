...
export const solutionProfiles: SolutionProfile[] = [
  ...
  },
  {
    ...
    buyer: 'COO or CFO, with Head of Asset Management or CIO as technical sponsor',
    velocity: '3–9 months',
  ...
  },
  {
    ...
    summary: 'Fund-level visibility across portfolio holdings — standardised reporting without building data teams in every SPV.',
